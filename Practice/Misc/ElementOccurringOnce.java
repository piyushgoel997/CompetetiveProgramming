...
/**
 * Created by piyus on 11-09-2017 at 22:43.
 * Find the element that occurs only once and every other element occurs thrice or twice in an array.
 * with Time complexity O(n), Space O(1).
 * Explanation at - https://www.careercup.com/question?id=7902674
 */
public class ElementOccurringOnce {

    public static void main(String[] args) {
        int[] arr = {1, 1,  3, 3, 3, 20, 4, 4, 4};
        int ones = 0;
        int twos = 0;
